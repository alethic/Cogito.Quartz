...
Cogito.Quartz — Provides utilites and extensions for Quartz.

Publishes 4 packages: `Cogito.Quartz`, `Cogito.Quartz.Autofac`, `Cogito.Quartz.Serilog`, `Cogito.Quartz.Serilog.Autofac`.
